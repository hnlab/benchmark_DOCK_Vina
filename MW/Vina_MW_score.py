...
#%%
import pandas as pd
vina_result = "/home/mxu02/dock37-test/test_dude/script/MW_analysis/all_vina.csv"
#%%
import re
...
plt.ylabel("Vina", size=15)
plt.title("Rp={:.4f}   p_value={:.3}".format(Rp, p_value))
# plt.show()
plt.savefig("/home/mxu02/dock37-test/test_dude/script/MW_analysis/Vina_score.png", dpi=300)
print(Rp,p_value)
